// https://gist.githubusercontent.com/udonba/2d5df5af2e327c0d75d4947d09b3e8db/raw/993ae31332d8fc986308e37e6ffa72a7190f45be/CatchLog.cs
using UnityEngine;
...
public class CatchLog : MonoBehaviour
{
    ...
    private void HandleLog(string logText, string stackTrace, LogType logType)
    {
        ...
        if (useTimeStamp)
            _builder.Append(string.Format("[{0}:{1:D3}] ", DateTime.Now.ToLongTimeString(), DateTime.Now.Millisecond));
