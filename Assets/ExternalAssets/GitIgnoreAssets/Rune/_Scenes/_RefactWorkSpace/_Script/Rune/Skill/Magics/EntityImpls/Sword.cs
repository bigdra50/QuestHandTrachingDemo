...
{
    public class Sword : MagicEntity, IDamager
    {
        ...
        public override EmitterPos Emitter => EmitterPos.OnGroundForward;
        public override MagicType MagicType => MagicType.Sword;
