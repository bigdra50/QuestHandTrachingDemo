    ...
    void Start()
    {
        ...
        this.UpdateAsObservable()
            ...
            .Subscribe(_ =>
            {
                ...
                _tmpText.text += "\n";
                _tmpText.text +=
                    $"IsStraight? T: {handGesture.IsExtendedFinger(_rSkelton, OVRPlugin.HandFinger.Thumb)}, I: {handGesture.IsExtendedFinger(_rSkelton, OVRPlugin.HandFinger.Index)}, M: {handGesture.IsExtendedFinger(_rSkelton, OVRPlugin.HandFinger.Middle)}, R: {handGesture.IsExtendedFinger(_rSkelton, OVRPlugin.HandFinger.Ring)}, P: {handGesture.IsExtendedFinger(_rSkelton, OVRPlugin.HandFinger.Pinky)}\n";
            });
    }
